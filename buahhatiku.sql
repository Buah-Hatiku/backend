...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2025 at 06:09 AM
...
INSERT INTO `payment_proofs` (`id`, `user_id`, `product_id`, `payment_proof_file`, `total_price`, `status`, `created_at`, `updated_at`) VALUES
(1, 9, 13, '6785ece798dcb0.63176642.jpg', 59500, 'pending', '2025-01-14 04:49:43', '2025-01-14 05:02:23'),
(2, 9, 13, '6785ed18d54941.42946068.jpg', 59500, 'pending', '2025-01-14 04:50:32', '2025-01-14 04:50:32');
...
(11, 'Bedak', 'download.jpg', 39, '12000.00', 12, 'Bedak Untuk Anak', '2025-01-13 04:18:21', '2025-01-13 04:18:21'),
(12, 'Susu Ibu hamil', 'f225ca7df8ac44535b41765e5c998880.jpg', 40, '30000.00', 12, 'Susu Ibu Hamil', '2025-01-13 04:18:51', '2025-01-13 04:18:51'),
(13, 'Skincare', '01845b06-afda-4078-a381-62bc504f163b.jpg', 41, '50000.00', 12, 'skincare bagus', '2025-01-13 04:19:17', '2025-01-13 04:19:17');
...
--
ALTER TABLE `payment_proofs`
  ADD CONSTRAINT `payment_proofs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `payment_proofs_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
